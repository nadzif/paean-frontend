...
import NewsContentPage from "./views/pages/news/newsContent";
      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<NavbarComp />} >
            ...
            <Route path="/newscontent/:id" element={<NewsContentPage />} />
            ...
            <Route path="/job/:id?/apply" element={<SubmitJobPage />} />
